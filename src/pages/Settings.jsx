...
import { useStore, updateSettings, exportBackup, importBackup, logActivity } from '../store.js';
...
import {
  ...
  Cog, AlertOctagon, ClipboardCheck, Zap, History,
} from 'lucide-react';
...
export default function Settings() {
  ...
  const DATA_ROWS = [
    ...
    { icon: AlertOctagon, label: 'Breakdown work orders', value: store.breakdowns.length, cls: 'text-red-400' },
    { icon: ClipboardCheck, label: 'PM schedules', value: store.pms.length, cls: 'text-emerald-400' },
    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="glass-card p-5">
        ...
        <p className="text-slate-500 text-[10px] mt-3 flex items-start gap-1.5">
          ...
          Maintenance records are stored in this browser's secure vault. Export a backup regularly and restore it on any device to migrate your data.
        </p>
      </div>
