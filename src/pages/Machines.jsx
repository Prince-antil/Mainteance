...
import {
  Plus, Search, Cog, MapPin, FileText, ChevronRight, Trash2, Factory, Download, HeartPulse,
} from 'lucide-react';
...
export default function Machines() {
  ...
  const sections = useMemo(
    () => [...new Set(machines.map((m) => m.section))].sort(),
    [machines]
  );
      ...
      <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
        <div>
          ...
          <p className="text-body mt-1.5">
            {machines.length} assets · specs, health scores, QR codes, SOPs, spares & maintenance history
          </p>
        </div>
